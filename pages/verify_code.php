...
<div class="vh-100 gradient-custom">
    ...
    margin: 15px;">
                    ...
                    <h3 class="title">Código de verificação</h3>


                    <form class="form-horizontal" action="login.php" method="post">
                        <div class="form-group">
                            <input type="text" id="code" name="code" required class="form-control" placeholder="Código de Verificação" required>
                        </div>
                        <button class="btn signin" type="submit" name="verify">Verificar</button>
                    </form>
                </div>
            </div>
        </div>
